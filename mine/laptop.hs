...
main = execute $ do
  ...
  profile "vim-related" $ do
    git "https://github.com/Shougo/vimproc" "git/vimproc" $ do
      registerAt ".vim/bundle/vimproc"
    git "https://github.com/eagletmt/ghcmod-vim" "git/ghcmod-vim" $ do
